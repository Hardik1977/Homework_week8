 ...
 */
public class SimpleCalculator_Prog18 {
    double firstNumber;
    double secondNumber;

    public double getFirstNumber() {   //method creation
        return firstNumber;
    }
    ...
    public void setFirstNumber(double firstNumber) {  // params method
    ...
    public static void main(String[] args) {
        SimpleCalculator_Prog18 calculator = new SimpleCalculator_Prog18();  // object creation
        calculator.setFirstNumber(5.0);
        calculator.setSecondNumber(4);
        System.out.println("add = " + calculator.getAdditionResult());
